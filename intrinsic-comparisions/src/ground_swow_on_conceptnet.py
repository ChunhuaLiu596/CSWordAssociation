...
class Ground(object):
    def __init__(self, args):
        ...
        # print(len(self.sw_net.edge_set))
        # print(len(self.sw_net.edge_list))
        # print(self.sw_net.graph.edgeCount)
        # sys.exit()
    ...
    def find_overlap_edges(self):
        ...
        print(len(self.sw_net.edge_set))
        print(self.sw_net.graph.edgeCount)
        print(overlap_edges_num)

        # assert len(self.sw_net.edge_set) - self.sw_net.graph.edgeCount == overlap_edges_num, f'{len(self.sw_net.edge_set), {self.sw_net.graph.edgeCount}, {overlap_edges_num}'
        assert len(self.sw_net.edge_set) - n == overlap_edges_num, f'{len(self.sw_net.edge_set)}, {n}, {overlap_edges_num}'
