...
def n_to_n_relations(train_path, valid_path, test_path, out_folder):
	'''
	...
	f = open(out_folder+"/type_constrain.txt", "w")
	f.write("%d\n"%(len(rellef)))
	for i in rellef:
	...
	f = open(test_path, "r")
	f11 = open(out_folder+"/1-1.txt", "w")
	f1n = open(out_folder+"/1-n.txt", "w")
	fn1 = open(out_folder+"/n-1.txt", "w")
	fnn = open(out_folder+"/n-n.txt", "w")
	fall = open(out_folder+"/test2id_all.txt", "w")
	tot = (int)(f.readline())
	fall.write("%d\n"%(tot))
	f11.write("%d\n"%(s11))
	f1n.write("%d\n"%(s1n))
